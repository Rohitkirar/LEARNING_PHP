                ...
                <div class='story_inner_div_items mb-5 p-5 bg-white'>
                    ...
                    <div class='p-4' style='width :45%; font-size:12px ; background-color:whitesmoke ;'>";
                        ...
                        foreach($resultArray as $key => $values){
                            ...
                            echo "<div style='display:flex; justify-content:space-between;' ><span>{$values['content']}</span>";

                            if($values['user_id'] == $_SESSION['user_id']){
                                echo "<a class='btn btn-danger' href='deleteComment.php?comment_id={$values['comment_id']}&story_id={$values['story_id']}'  style='float:right; text-decoration:none;'>Delete</a>";
                            }
