    ...
    <main class="container p-4 ">
        ...
        <div class="m-0">
            <div class="container p-4 shadow-lg m-2 rounded "  >
                ...
                <div>
                    <p><span style="color:black;">Blog content : </span> The content should demonstrate expertise, authoritativeness, and trustworthiness (EAT). It is also important to use easy-to-understand language and formatting to make the blog post digestible.</p>
                    <p><span style="color:black;">Inviting headlines :</span> These reveal what the content is about and help attract visitors to the content, as around 80% of people will click search engine results if the headlines are compelling.</p>
                    <p><span style="color:black;">Regularly-updated content : </span> A regular publishing schedule helps people know when to visit the blog for new content. Search engines also prioritize fresh and up-to-date content, helping increase rankings and website traffic.</p>
                    <p><span style="color:black;">Smooth user experience (UX) : </span> Other than attractive design, great blogs generally have a seamless page experience as it is an important element in blog search engine optimization (SEO). It includes mobile friendliness, HTTPS, and loading speed – including improving Core Web Vitals, the performance metrics assessing how good user experience is.</p>
                </div>       
            </div>
