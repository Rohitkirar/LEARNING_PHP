...
<body>
    ...
    <main>
        ...
        <div>
            <span><strong style="color:white; font-size:x-large">Story View</strong></span>
                ...
                <div class='story_inner_div_items m-2 mb-5 p-5 shadow-lg bg-white rounded'>
                    ...
                    <div class='postnavdiv'>
                        ...
                        <div style='margin : 0 auto'>
                            ...
                            <a href="updateStoryForm.php?story_id=<?php echo $values['story_id'] ?>" class='btn btn-primary'>Update Story</a>

                            <a href="deleteStory.php?story_id=<?php echo $values['story_id'] ?>" class='btn btn-danger' onclick="return confirm('Do you want to delete the story')">Delete Story</a>
