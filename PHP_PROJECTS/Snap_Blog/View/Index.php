...
<body>
    ...
    <main role="main">
      ...
      <section class="jumbotron text-center ">
        <div class="container "  style="background-color: whitesmoke; height:25rem ; ">
          <h1 class="jumbotron-heading">Snap Blog</h1>
        ...
        <div class="container"  style="background-color:gray; height:25rem ; ">
