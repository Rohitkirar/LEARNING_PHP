...
<body>
  ...
  <main role="main">
    ...
    <div id="myCarousel" class="carousel slide wet-asphalt bg-white " data-bs-ride="carousel" data-ride="carousel"
            ...
            <?php if ($key == 0) { ?>
              <div class="carousel-item active card p-4 " style="transition-duration: 1.5s; " >
                <a href="adminstoryview.php?story_id=<?php echo $values['story_id'] ?>">
                  <div>
                    <img class="d-block w-100 " style="object-fit:fill; height:35rem;"
                      src="../../Upload/<?php echo $imageArray[0]['image'] ?>" alt="First slide">
                  </div>
            ...
            <div class="m-3 shadow-lg card">
              ...
              <div class=" m-2 text-center" >
                ...
                <div class="btn-group mb-2">
                  ...
                  <a href="updateStoryForm.php?story_id=<?php echo $values['story_id'] ?>"
