<form action="{{ route('users.store') }}" method="POST">
    ...
    <div class="form-group">
        ...
        <input type="text" name="gender" id="gender" value="{{ old('gender') }}" class="form-control @error('gender') is-invalid @enderror " />
    ...
    <div class="form-group">
        ...
        @error("username") <span class="text-danger">{{ $errors->first('username') }}</span> @enderror
    </div>
    ...
    <div class="form-group">
        ...
        @error("password_confimation") <span class="text-danger">{{ $errors->first('password_confimation') }}</span> @enderror
    </div>
